/**
 * Copyright @delight-im from Github. https://github.com/delight-im/Javadoc-to-Markdown
 *
 ...
 * @constructor
 */
module.exports = JavadocToMarkdown = function () {
    ...
    String.prototype.repeat = function(count) {
        return new Array(count + 1 || 1).join(this);
    };
